<?php
	class CommentSection{
		...
		private function createCommentSection(){
			...
			$commentButton = ButtonProvider::createButton("Оставить комментарий", null, $commentAction, "postComment");
			...
			return "<div class='commentSection'>
						<div class='header'>
							<span class='commentCount'>Комментариев: $numComments</span>

							<div class='commentForm'>
								$profileButton
								<textarea class='commentBodyClass' placeholder='Введите текст комментария'></textarea>
									$commentButton
							</div>
						</div>
