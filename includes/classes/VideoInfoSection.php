<?php
	...
	class VideoInfoSection{
		...
		private function createPrimaryInfo(){
			...
			return "<div class='videoInfo'>
						...
						<div class='bottomSection'>
							<span class='viewCount'>Просмотров: $views</span>
							$controls
						</div>
					</div>
			";
		...
		private function createSecondaryInfo(){
            ...
            $uploadedBy = $this->video->getUploadedById();

			$profileButton = ButtonProvider::createUserProfileButton($this->con, $uploadedBy);

			if($uploadedBy == $this->userLoggedInObj->getId()){
			...
			return "<div class='secondaryInfo'>
						<div class='topRow'>
							...
							<div class='uploadInfo'>
								<span class='owner'>
									<a href='profile.php?id=$uploadedBy'>
										$username
									</a>
								</span>
								<span class='date'>Опубликовано: $uploadDate</span>
							</div>
							$actionButton
						</div>
