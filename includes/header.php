<?php
    ...
    require_once ("includes/classes/RecommendationSystem.php");
...
<head>
    ...
    <link type="image/x-icon" href="assets/images/icons/favicon.png" rel="shortcut icon">
</head>
<body>
		...
		<div id="mastHeadContainer">
			...
			<div class="searchBarContainer">
				<form action="search.php" method="GET">
					<input type="text" class="searchBar" name="term" placeholder="Поиск...">
			...
			<div class="rightIcons">
				...
				<?php echo ButtonProvider::createUserProfileNavigationButton($con, $userLoggedInObj->getId());?>
			</div>
